...
export default function TemplateSelector({ selectedTemplate, setSelectedTemplate }) {
  ...
  return (
    <div className="mt-6 relative" ref={containerRef}>
      <h3 className="text-gray-700 font-semibold mb-2 dark:text-gray-300">
        Choose Template
      </h3>

      {/* Outer box */}
      <div
        className={`border rounded-lg bg-white dark:bg-gray-800 transition-all duration-300 overflow-hidden ${
